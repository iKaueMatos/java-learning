...
> Basicamente esse projeto tem como objetivo aprender mais sobre a sintaxe do java e desenvolver um sistema de banco com orientação ao objetos(Metodos,atribudos,get,seter) !. 

### Ajustes e melhorias

O projeto ainda está em desenvolvimento e as próximas atualizações serão voltadas nas seguintes tarefas:

- [ ] Tarefa 1 - Criar classes
- [ ] Tarefa 2
- [ ] Tarefa 3
- [ ] Tarefa 4
- [ ] Tarefa 5
